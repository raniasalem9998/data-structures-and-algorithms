...
Build a simple express server. Connect a '/hello' route that sends
 a greeting of your  choice. Connect a '/aboutme' route that sends
  a short bio about you to the front-end. Finally, connect a '/favoritefoods' 
  route that sends an array to the front-end of your favorite foods. All other
  routes should respond with a status of 404.
------------------------------------------------------------------------------------------------ */
...
const divisibleByFiveTwoToThePower = (input) => {
  ...
  return input.map(subarr=>{
    ...
    let arr=[]
      ...
      subarr.map(element=>{
      if (element%5 == 0 && typeof(element)=='number'&& Number.isFinite(element) )
