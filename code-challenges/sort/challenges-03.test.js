...
const changeAllClassNames = () => {
  // Solution code here...
  $("li.apple, li.orange").addClass("fruit");
...
Write a function named sortByLength that takes in an array of strings and returns 
the same array, with the strings sorted by their length, lowest to highest.
------------------------------------------------------------------------------------------------ */
