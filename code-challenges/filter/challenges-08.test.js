...
Write a function named sayHello, that sends the message 'Hello from 
the back-end' when a user hits the `/hello` route.
...
Write a function named oddValues that, given an array of integers as 
input, uses filter to return an array containing only the odd integers.
...
Write a function named filterStringsWithVowels that,
 given an array of strings as input, uses filter to 
 return an array with only words that contain vowels.
