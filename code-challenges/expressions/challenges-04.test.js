...
Without altering the html, write a function named generateSubmitButton that uses jQuery to create a 
submit button with the text "submit" and append it to the DOM.
------------------------------------------------------------------------------------------------ */
...
const generateSubmitButton = () => {
    var txt1 = "<button>submit</button>";               // Create element with HTML 
    
    $("form").append(txt1);      // Append the new elements
...
Write a function named citiesAtoJ that takes in an
 array of city names and uses a regular expression 
