...
First, write a function called mapCurrentEvents that maps over the current events object, runs it
 through a constructor function and returns the resulting array.
...
const mapCurrentEvents = () => {
   return currentEvents.news.map(e=> {return new Event(e)})
  // Solution code here...
}
...
const countNumberOfElements = (arr) => {
  return arr.reduce((acc,val,ind)=>{return acc+1;
},0 )
...
Write a function named reversedString that
 takes in a string and returns a string with 
...
let arr = str.split('');
return arr.reduce((newString,curretString)=>{return curretString+newString;},'');
  // Solution code here...
};
